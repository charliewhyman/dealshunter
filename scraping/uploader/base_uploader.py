...
class BaseUploader(ABC):
    ...
    def cleanup_stale_records(self, current_ids: List[str], shop_id: Optional[str] = None):
        ...
        try:
            ...
            # Normalize IDs from DB and current_ids to strings
            # result is list of dict_row or dicts
            ...
            return self.db.bulk_delete(table_name, to_delete)
